...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> cotizacion Mostrados</h2>
            <div class="box-icon">
            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <?php
                    for($i=0; $i<count($cotizacion); $i++)
                    {
                        ...
                        $id_cotizacion = $current['id_cotizacion'];                        
                        ...
                        echo '<a class="btn btn-small btn-success" href="mainpanel/cotizacion/detalle_mostrado/'.$id_cotizacion.'"><i class="icon-file icon-white"></i>  Ver Datos</a> ';
                        echo '<a class="btn btn-danger" href="javascript:deleteMsgMostrado(\''.$id_cotizacion.'\')"><i class="icon-trash icon-white"></i>Borrar</a> ';
                        echo '</td>';
                        echo '</tr>';
                    }
                ?>
