...
<head>
	<meta charset="utf-8">
	<title>Zona de Administración :: INDUSTRIAL V&G ::</title>
        <base href="<?php echo base_url(); ?>" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Floristeria">
    <meta name="author" content="Floristeria">

    <link rel="shortcut icon" href="assets/frontend/images/ico.ico" type="image/x-icon" >
...
<div class="row-fluid">
    <div class="span12 center login-header">
        <h2>Zona de Administración - INDUSTRIAL V&G</h2>
    </div><!--/span-->
</div><!--/row-->
        ...
        <form class="form-horizontal" action="mainpanel/validar" method="post">
            <fieldset>
                ...
                if($this->session->userdata('captchaError'))
                {
                    ...
                    echo $this->session->userdata('captchaError');
                    echo '</div>';
                    $this->session->unset_userdata('captchaError');
                }
                ?>
                <div class="alert alert-info">Ingresar el código de la imagen<em class="required">*</em></div>
                    <input type="text" class="input-text" title="Captcha" id="codigo" name="codigo" required>
