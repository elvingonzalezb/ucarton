  ...
  class Controller_contacto extends CI_Controller{
    ...
    public function index(){
      ...
      $vals = array(
                ...
                'img_url' => 'http://www.misticadigital.com/py_ucartonera/assets/frontend/captcha/',
      ...
      //mapa
        ...
        $dataPrincipal["mapa2"] = $this->model_ubicanos->getMapa(1);

      //print_r($dataPrincipal["mapa2"]); return;
              ...
              // envio de mail de notificacion on el php mailer
                  ...
                  $mail = new PHPMailer();
                    ...
                    $msg .= "===============================================================<br />\n";
                      ...
                      $msg .= '<strong>INDUSTRIAL V&G</strong><br>';
...

    {
        ...
        $datos=array();
            ...
            $resultado = $this->Model_contacto->envioCotizacion($datos);
...

            {
              ...
              // envio de mail de notificacion on el php mailer
                  ...
                  $mail = new PHPMailer();
                    ...
                    $mail->Subject = $datos["asunto"]." - Mensaje desde el formulario de cotizacion de impresiones";

                    $msg = "Se ha enviado el siguiente mensaje desde el formulario de cotizacion de impresiones.<br>\n";
                    ...
                    $msg .= "===============================================================<br />\n";
                      ...
                      $msg .= 'TELEFONO: '.getConfig("telefono").'<br>';
                    ...
                    $this->session->set_userdata("success", "Cotización  enviada, nos pondremos en contacto con usted gracias!");
