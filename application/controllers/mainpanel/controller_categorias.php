<?php 
	class Controller_categorias extends CI_Controller 
	{
		public function __construct()
		{
			...
			//$this->load->model("mainpanel/model_comentarios_categorias");
		...
		public function listar()
		{
	        ...
	        $data['cuerpo']="categorias/index_view";

	        $categorias = $this->model_categorias->getListacategorias(0);
		...
		public function nuevo()
		{
			...
			$data["cuerpo"] = "categorias/nuevo_view";
			// ************************************
			$ulti = $this->model_categorias->ultimo_categorias();
		...
		public function grabar()
		{
			...
			if($this->my_upload->uploaded == true)
			{
	            ...
	            if($this->my_upload->processed == true)
	            {
	            	...
	            	$resultado = $this->model_categorias->grabarcategorias($data);
	            	if($resultado==true)
	            	{
		...
		public function edit($id)
		{
	        ...
	        $this->load->view('mainpanel/includes/header_view', $menu, true);
	        $this->load->view('mainpanel/includes/footer_view', $data, true); 
	        $data['cuerpo']="categorias/edit_view";
	        $categorias = $this->model_categorias->getcategorias($id);
	        $data['categorias'] = $categorias;
	        $this->load->view("mainpanel/includes/template", $data);
	   	}
	   	...
	   	public function actualizar()
	   	{
	        ...
	        if ( $this->my_upload->uploaded == true  )
	        {
	            ...
	            if ($this->my_upload->processed == true ) {
	                ...
	                redirect('mainpanel/categorias/edit/'.$id_novedad); 
	            }
	        }
	        $result=$this->model_categorias->updatecategorias($id_novedad, $data);
	        if($result==true){
   		...
   		public function borrar($id)
   		{
   			...
   			$secciones= $this->model_categorias->getcategorias($id);
	    	...
	    	$result = $this->model_categorias->deletesubcategorias($id);
	    	// BORRAMOS LA CATEGORIA
   			$result = $this->model_categorias->deletecategorias($id);
